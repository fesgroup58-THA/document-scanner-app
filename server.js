...
app.post('/api/public-send', async (req, res) => {
  try {
    const { senderName, senderCompany, emailSubject, emailMessage, attachments } = req.body;
    ...
    const emailBody = '📨 มีเอกสารใหม่ส่งเข้ามา\n\n' +
      '👤 ผู้ส่ง: ' + senderName + '\n' +
      (senderCompany ? '🏢 บริษัท/แผนก: ' + senderCompany + '\n' : '') +
